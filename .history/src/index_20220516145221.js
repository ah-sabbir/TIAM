...
btn.addEventListener("click",function(){
    ...
    FullAddressCleaned = (PropertyAddress+City+State+ZipCode).replace(punctuationRegEx, '').replace(/(\s){2,}/g, '$1').toLowerCase().replaceAll(/\s/g,'');

    console.log(FullAddressCleaned, PropertyAddress);
