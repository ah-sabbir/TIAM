...
btn.addEventListener("click",function(){
    ...
    FullAddressCleaned = (PropertyAddress.replace(" ","")+City.replace(" ","")+State.replace(" ","")+ZipCode.replace(" ","")).replace(punctuationRegEx, '').replace(/(\s){2,}/g, '$1').toLowerCase();

    console.log(FullAddressCleaned, PropertyAddress.replaceAll(/\s/g,''));
