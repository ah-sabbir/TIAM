...
contextBridge.exposeInMainWorld("api",{
    ...
    create__Toronto: async(Owner, PropertyAddress, City, State, ZipCode, FullAddressCleaned)=>{
    ...
    create_New_Vencouver: async (Owner, PropertyAddress, City, State, ZipCode, FullAddressCleaned)=>{
